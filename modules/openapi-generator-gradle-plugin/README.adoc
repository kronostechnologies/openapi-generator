...
----
plugins {
  id "com.equisoft.openapi.generator" version "7.12.0"
}
----
...
buildscript {
  ...
  dependencies {
    classpath "com.equisoft.openapitools:openapi-generator-gradle-plugin:7.10.0"
  }
}

apply plugin: 'com.equisoft.openapi.generator'
----
//# /RELEASE_VERSION
...
buildscript {
    ...
    dependencies {
        ...
        classpath('com.equisoft.openapitools:openapi-generator-gradle-plugin:1.10.0') {
